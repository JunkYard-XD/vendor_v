...
define addVar
  ...
  SOONG_CONFIG_derpVarsPlugin_$(1) := $($1)
endef
...
SOONG_CONFIG_derpGlobalVars_gralloc_handle_has_ubwcp_format := $(TARGET_GRALLOC_HANDLE_HAS_UBWCP_FORMAT)
...
SOONG_CONFIG_derpGlobalVars_target_power_libperfmgr_mode_extension_lib := $(TARGET_POWER_LIBPERFMGR_MODE_EXTENSION_LIB)
SOONG_CONFIG_derpGlobalVars_target_powershare_path := $(TARGET_POWERSHARE_PATH)
SOONG_CONFIG_derpGlobalVars_target_powershare_enabled := $(TARGET_POWERSHARE_ENABLED)
SOONG_CONFIG_derpGlobalVars_target_powershare_disabled := $(TARGET_POWERSHARE_DISABLED)
...
SOONG_CONFIG_derpQcomVars_qti_vibrator_effect_lib := $(TARGET_QTI_VIBRATOR_EFFECT_LIB)
